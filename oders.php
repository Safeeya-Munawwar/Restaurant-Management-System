        ...
        <table class="table1">
            ...
            <tr>
                <!-- FETCHING DATA FROM EACH
                    ...
                    <td><?php echo $rows['table_number'];?></td>  
      ...
      <div class="d2">
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo $rows['table_number'];?></td>
                <td><?php echo $rows['item_ordered_name'];?></td>
                <td><?php echo $rows['amount'];?></td>
                <td><?php echo $rows['quantity'];?></td>
                <td><?php echo $rows['total_amount'];?></td>
                <td><a href="delete_orders.php?order_id=<?php echo $rows['order_id']; ?>"><input type="button" value="DELETE"></a></td>
            </tr>
            <?php
                }
            ?>
