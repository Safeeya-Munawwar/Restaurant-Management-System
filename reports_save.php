...
<html lang="en">
    ...
    <center>
        ...
        if (isset($_POST['generate_report'])) {
            ...
            $conn_reservation = new mysqli($servername, $username, $password, "tablesnew");
            ...
            $conn_orders = new mysqli($servername, $username, $password, "tablesnew");
            ...
            $conn_payments = new mysqli($servername, $username, $password, "tablesnew");
            ...
            if ($result_reservation->num_rows > 0) {
                ...
                while($row = $result_reservation->fetch_assoc()) {
                    echo "<tr><td>".$row["id"]."</td><td>".$row["first_name"]."</td><td>".$row["last_name"]."</td><td>".$row["numberofguests"]."</td><td>".$row["email"]."</td><td>".$row["phone"]."</td><td>".$row["date"]."</td><td>".$row["time"]."</td><td>".$row["table_number"]."</td><td>".$row["specialoccasion"]."</td></tr>";
                }
                echo "</table>";
            } else {
            ...
            if ($result_orders->num_rows > 0) {
                ...
                while($row = $result_orders->fetch_assoc()) {
                    echo "<tr><td>".$row["reservation_id"]."</td><td>".$row["order_id"]."</td><td>".$row["table_number"]."</td><td>".$row["item_ordered_name"]."</td><td>".$row["quantity"]."</td><td>".$row["amount"]."</td><td>".$row["total_amount"]."</td></tr>";
                }
                echo "</table>";
            } else {
